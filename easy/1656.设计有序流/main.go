...
// author: fengyuwusong date: 2022-08-16 00:09:23
...
func (this *OrderedStream) Insert(idKey int, value string) []string {
	...
	this.dataSet[idKey] = true
	for ; this.curr < len(this.data) && this.dataSet[this.curr]; this.curr++ {
		res = append(res, this.data[this.curr])
	}
	return res
}
